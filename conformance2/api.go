...
const (
	apiTagList  apiType = iota
	apiBlobPush         // any blob push API
	apiBlobPostOnly
	apiBlobPostPut
	apiBlobPatchChunk
	apiBlobPatchStream
	apiBlobMountSource
	apiBlobMountAnonymous
	apiBlobGetFull
	apiBlobGetRange
	apiBlobDelete
	apiManifestPutDigest
	apiManifestPutTag
	apiManifestPutSubject
	apiManifestGetDigest
	apiManifestGetTag
	apiManifestDeleteTag
	apiManifestDeleteDigest
	apiReferrers
	apiMax // number of APIs for iterating
)
...
func (a apiType) String() string {
	...
	case apiBlobPatchChunk:
		return "Blob chunked"
	case apiBlobPatchStream:
		return "Blob streaming"
	case apiBlobMountSource:
		return "Blob mount"
	case apiBlobMountAnonymous:
		return "Blob anonymous mount"
	case apiBlobGetFull:
		return "Blob get"
	case apiBlobGetRange:
		return "Blob get range"
	case apiBlobDelete:
		return "Blob delete"
	case apiManifestPutDigest:
		return "Manifest put by digest"
	case apiManifestPutTag:
		return "Manifest put by tag"
	case apiManifestPutSubject:
		return "Manifest put with subject"
	case apiManifestGetDigest:
		return "Manifest get by digest"
	case apiManifestGetTag:
...
func (a *apiType) UnmarshalText(b []byte) error {
	...
	case "Blob chunked":
		*a = apiBlobPatchChunk
	case "Blob streaming":
		*a = apiBlobPatchStream
	case "Blob mount":
		*a = apiBlobMountSource
	case "Blob anonymous mount":
		*a = apiBlobMountAnonymous
	case "Blob get":
		*a = apiBlobGetFull
	case "Blob get range":
		*a = apiBlobGetRange
