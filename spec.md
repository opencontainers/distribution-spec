...
1. MUST support pushing 10 tags at once, and SHOULD NOT set an upper limit
1. MUST return a `414 Request-URI Too Long` status if rejecting the request for pushing more than 10 tags, and clients MAY retry with fewer tags
